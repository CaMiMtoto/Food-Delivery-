        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackingFee = table.Column<decimal>(type: "numeric(5,0)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraProduct", x => new { x.ProductId, x.ExtraId });
                    table.ForeignKey(
                        name: "FK_ExtraProduct_Extras_ExtraId",
                        column: x => x.ExtraId,
